        ...
        <main className="antialiased gap-y-0">
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-7">
                <a className="col-start-1 col-span-12" href="/projects/88rising">
                    ...
                    <div className="col-start-1 row-start-2 font-favorit text-bodycopy col-span-6">
                        <h4 className="mt-thumbnail-top">88rising</h4>
                        <h4 className="-mt-1 text-customGray">Experience Design</h4>
                    </div>
                    <div className="col-start-6 row-start-2 font-favorit text-bodycopy col-span-6">
                    ...
                    <div className="col-start-12 row-start-2 font-favorit text-bodycopy col-span-1">
                        <h4 className="mt-thumbnail-top text-right">2023</h4>
                    </div>
                <div className="col-start-13 row-start-2 font-favorit text-bodycopy col-span-6">
                    <h4 className="mt-thumbnail-top">Give Me Yesterday</h4>
                    <h4 className="-mt-1 text-customGray">Interaction Design, Art Direction</h4>
                </div>

                <div className="col-start-18 row-start-2 font-favorit text-bodycopy col-span-6">
                ...
                <div className="col-start-24 row-start-2 font-favorit text-bodycopy col-span-1">
