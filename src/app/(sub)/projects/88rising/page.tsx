        ...
        <main className="antialiased gap-y-0">
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-20">
                <div className="col-start-1 col-span-9">
                    ...
                    <p className="text-base font-favorit mt-4">
                        ...
                        East and West. Through the promotion of Asian and Asian American culture across diverse media platforms, the company aims to foster a deeper understanding and appreciation. This redesigned 88rising website serves as a touchpoint for fans, offering an enhanced experience to explore details about their cherished artists, while also extending support to lesser-known talents, thereby expanding their influence.
                    </p>
                    <p className="text-base font-favorit mt-4">
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-20">
                <div className="col-start-1 col-span-9">
                    ...
                    <p className="text-base font-favorit mt-4">
                        Despite a successful debut, they have struggled to maintain momentum, losing over 2.6 billion viewerships in the past 4 years.
                        To find the root of the problem the team conducted user interviews and surveys involving 89 respondents spanning from casual to
                        die-hard fans, we aimed to delve into the core issues surrounding music-sharing habits and perceptions of 88rising and its roster
                        of artists.
                    </p>
                </div>
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-20">
                <div className="col-start-1 col-span-9">
                    ...
                    <p className="text-base font-favorit mt-4">
                        ...
                        as 62% of respondents were unaware of 88rising's monthly releases. Despite the consensus uncovered by user surveys regarding a decline in popularity,
                        41% of casual fans linked it to perceived low engagement from the brand.
                        These fans expressed interest in discovering new talents and experiencing the signature sounds associated with 88rising.
                    </p>
                </div>
                ...
                <div className="col-start-12 col-span-12">
                    <p className="text-2xl font-favorit mt-8 leading-8">
                        The big names seem stagnant, while many new artists lack exposure, creating an opportunity for more variety.
                        This introduces people to different sounds beyond the usual big names, providing something new to discover and listen to.
                    </p>
                    <p className="text-xs font-favorit mt-4 text-customGray">
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-20">
                <div className="col-start-1 col-span-9">
                    ...
                    <p className="text-base font-favorit mt-4">
                        From a business perspective, my team and I identified that 88rising fans were struggling to engage with the diverse roster
                        and collaborative content scattered across various platforms. We proposed an intervention leveraging 88rising's unique Asian
                        American identity and diverse artists to enhance fan discovery, connection, and provide visibility to artists who were previously overlooked.
                    </p>
                </div>
            ...
            <div className="mx-8 grid grid-cols-24 gap-x-5 mt-20">
                <div className="col-start-1 col-span-9">
                    ...
                    <p className="text-base font-favorit mt-4">
                        This intervention invite fans to explore and delve deeper into artists they may not have encountered previously.
                        It also introduces fans to the latest album releases,
                        fostering a dynamic environment for continuous discovery and appreciation of diverse musical experiences.
                    </p>
                </div>
